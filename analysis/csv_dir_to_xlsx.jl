...
new_results = [("results/Mar14/", "Mar16.xlsx")]
...
for (d, n) in new_results
	...
	df = select(df, [:method, :termination, :problem_id, :problem_dataset,
		...
		Symbol("phase 1 time"), Symbol("phase 1 gap"),
		Symbol("phase 2 time"), Symbol("phase 2 gap"),
		Symbol("phase 3 time"), Symbol("phase 3 gap"),
		Symbol("phase 4 time"), Symbol("phase 4 gap"),
		Symbol("phase 5 time"), Symbol("phase 5 gap"),
		])
	XLSX.writetable(
			n,
			results = (
